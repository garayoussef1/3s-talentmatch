...
SKILLS_DATABASE: Dict[str, List[str]] = {
    ...
    "marketing_digital": [
        ...
        "Instagram Ads", "TikTok Ads", "Snapchat Ads",
        "SEO", "SEM", "PPC", "CRO", "SEA",
    ...
    "comptabilite_finance": [
        "Sage", "Ciel", "EBP", "Compta Pro",
        "SAP", "SAP FI", "SAP CO", "SAP FI/CO",
        "Odoo", "Oracle", "Microsoft Dynamics",
        "IFRS", "PCG", "Normes IFRS", "PCG tunisien",
        "Audit", "Audit financier", "Commissariat aux comptes",
        "Consolidation", "Consolidation comptes",
        "Comptabilité générale", "Comptabilité analytique",
        "Gestion budgétaire", "Contrôle de gestion",
        "Analyse financière", "Reporting financier",
        "Fiscalité", "Déclarations fiscales",
        "IS", "TVA", "IR", "Taxe professionnelle",
    ],
    "sante_medical": [
        "Soins intensifs", "Soins d'urgence",
        "Réanimation", "RCP", "Réanimation cardio-pulmonaire",
        "Monitoring cardiaque", "ECG", "Électrocardiogramme",
        "Ventilation mécanique",
        "Cathétérisme", "Perfusions", "Perfusions IV",
        "Prélèvements sanguins",
        "Pansements", "Soins post-opératoires",
        "Gestion douleur", "Soins palliatifs",
        "Asepsie", "Hygiène hospitalière",
        "Éducation thérapeutique",
        "Hosix", "Dossier patient électronique",
    ],
    "rh_recrutement": [
        "Workday", "SAP SuccessFactors", "SAP HCM",
        "Lever", "Greenhouse", "Recruitee", "Taleo",
        "LinkedIn Recruiter",
        "BambooHR", "Gusto", "Personio",
        "GPEC", "Gestion prévisionnelle emplois",
        "ATS", "Applicant Tracking System",
        "Recrutement", "Sourcing", "Talent Acquisition",
    ...
    "metiers_manuels": [
        ...
        "Tableaux électriques", "Câblage électrique",
        "Normes électriques", "Norme NFC 15-100",
        ...
        "Soudure", "Mécanique auto", "Mécanique industrielle",
    ],
}
